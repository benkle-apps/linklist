...
class CountUrlsCommand extends ContainerAwareCommand
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this
            ->setName('app:url:count')
            ->setDescription('Count URLs owned by a user')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $count = $this->getContainer()->get('app.url_manager')->countUrls($user, $options);
